...
export const DashSide = () => {
    ...
    return (
        ...
        <div className='h-screen lg:w-[7%] xl:w-[5.5%] 2xl:w-[4%] 2xl:hover:w-[15%] hover:w-1/5 hover:transition-[width] hover:ease-out duration-300 bg-secondary flex flex-col overflow-hidden text-white fixed top-0 left-0 pt-[4.1rem] z-10'>
