...
export const DynamicSection:NextPage<Props> = (Props)=> {
    ...
    return (
        <div className='bg-gradient-to-tl from-sky-100 to-blue-500 sm:flex-col lg:flex-row flex items-center justify-center sm:h-auto xl:h-[60vh] lg:h-[50vh]'>
            <div className='lg:flex justify-between items-center py-12 2xl:py-20  xl:px-24 sm:p-10  lg:px-12 2xl:w-[1440px] m-auto'>
                ...
                <div className="text-black sm:w-full lg:w-[40%] 2xl:w-1/2">
                    ...
                    <Link href="/pricing" ><a className="px-10 py-4 bg-sky-600 text-white rounded-md">Get started</a>
                    </Link>
                </div>

                <div className="lg:w-[33%] sm:w-full sm:mt-20 lg:m-0">
