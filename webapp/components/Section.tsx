...
export const Section:NextPage<Props> = (Props)=> {
    ...
    return (
        <div className='lg:flex justify-between items-center lg:py-12 2xl:py-20 sm:hidden bg-primary  xl:px-24 sm:p-4  lg:px-12 2xl:px-32'>
        <div className="text-white lg:w-[46%] 2xl:w-1/2">

            <h3 className="xl:text-4xl 2xl:text-5xl lg:text-4xl xl:leading-normal font-semibold mb-8 2xl:mb-16">
                {sectionTitle}
            </h3>
