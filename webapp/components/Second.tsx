    ...
    return (
        <div className="bg-white lg:py-16 lg:px-24 sm:p-4 my-4 flex items-center justify-center flex-col">
            <div className="text-center sm:mb-12 2xl:mb-20">
                <h2 className="lg:text-4xl 2xl:text-5xl sm:text-2xl font-semibold sm:mb-5 2xl:mb-8">Discover the seller winning in the market</h2>
                <h4 className="xl:text-xl xl:px-60 lg:px-24 lg:text-base 2xl:px-[35rem] 2xl:text-3xl sm:text-sm">With RobotDorm chrome extension you spy on your competitors, have accurate product informations and estimated revenue generated</h4>
            </div>
