...
export const newUserTemplate = ({url,email,token}: Record<"url" | "email"|"token", string>) => {
              ...
              <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                ...
                <tr>
                    <td style="background-color:#ffffff;padding: 20px">
                      <p style="margin:0;">A request to register was made from: <span style="font-weight:600;">${espacedEmail}</span>
                      </p>
                    </td>
                </tr>
                <tr>
                    <td style="background-color:#ffffff;padding:10px 20px">
                      <p style="margin:0;">Your registration confirmation code</p>
                    </td>
                </tr>
                <tr >
