    ...
    return (
        <div className="bg-white lg:py-16 lg:px-24 sm:p-4 my-4 flex items-center justify-center flex-col">
            <div className="text-center sm:mb-12 2xl:mb-20">
                <h2 className="lg:text-4xl 2xl:text-5xl sm:text-2xl font-semibold sm:mb-5 2xl:mb-8">Discover the products winning in the market</h2>
                <h4 className="xl:text-xl xl:px-60 lg:px-24 lg:text-base 2xl:px-80 2xl:text-3xl sm:text-sm">With RobotDorm chrome extension you can use the best data available on jumia to make informed decision to grow your online business.</h4>
            </div>
