...
export const Section:NextPage<Props> = (Props)=> {
    ...
    return (
        <div className='bg-secondary lg:flex-row sm:flex-col  items-center justify-center xl:h-[60vh] lg:h-[50vh]'>
            ...
            <div className="text-white lg:w-[46%] 2xl:w-1/2">
                ...
                <h3 className="xl:text-4xl sm:text-4xl xl:leading-normal font-semibold mb-8 2xl:mb-10">
                    {sectionTitle}
                </h3>
            ...
            <Link href="https://chromewebstore.google.com/detail/iebnenlmoeolohhmbjilijlgpjbjljhm?hl=en-GB">
                <a className="px-8 py-4 bg-white text-primary rounded-lg sm:hidden lg:inline-block">Install Chrome Extension</a>
            </Link>

            <Link href="/dashboard">
                <a className="px-8 py-4 bg-white text-primary rounded-lg lg:hidden">Start a free trial</a>
            </Link>
            </div>
